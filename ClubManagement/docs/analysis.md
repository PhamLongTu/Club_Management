...
hoạt động như tổ chức sự kiện, quản lý thành viên, thực hiện dự án, to chuc cac buoi hop. Tuy nhiên, phần lớn các CLB vẫn đang sử dụng phương thức quản lý
...
8. **Lịch họp không rõ ràng**: Khó theo dõi thời gian, địa điểm và người chủ trì.
...
- Quản lý lịch họp và thông tin cuộc họp tập trung
...
- **PK**: meeting_id
- **Attributes**: title, content, start_time, end_time, location, meet_link, host_id
- **Ý nghĩa**: Lưu lịch họp, địa điểm/online, và người chủ trì
